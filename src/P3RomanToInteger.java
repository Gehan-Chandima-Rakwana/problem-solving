...
//        Explanation: M = 1000, CM = 900, XC = 90 and IV = 4.
        ...
        String s = "III";
        int num = new P3RomanToInteger().romanToInt(s);
        System.out.println("Scenario 1: " + num);

        s = "LVIII";
        num = new P3RomanToInteger().romanToInt(s);
        System.out.println("Scenario 2: " + num);

        s = "MCMXCIV";
        num = new P3RomanToInteger().romanToInt(s);
        System.out.println("Scenario 3: " + num);
